package com.aurionpro.test.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.aurionpro.test.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.aurionpro.test.security.DomainUserDetailsService", "createSpringSecurityUser");
